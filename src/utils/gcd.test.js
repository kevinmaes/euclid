...
describe('gcdSteps()', () => {
  xit('should return the greatest common divisor when a % b is 0', () => {
  ...
  xit('should return the greatest common divisor when a % b is not 0', () => {
  ...
  xit('should return the greatest common divisor when a and b have no gcd other than 1', () => {
  ...
  xit('should return the greatest common divisor wxithin 3 steps', () => {
  ...
  xit('should return the greatest common divisor within 3 steps', () => {
